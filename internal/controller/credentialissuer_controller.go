...
// CredentialIssuerReconciler reconciles a CredentialIssuer object
type CredentialIssuerReconciler struct {
	client.Client
	Scheme *runtime.Scheme
}

// +kubebuilder:rbac:groups=vc.vc-operator.io,resources=credentialissuers,verbs=get;list;watch;create;update;patch;delete
...
// the CredentialIssuer object against the actual cluster state, and then
